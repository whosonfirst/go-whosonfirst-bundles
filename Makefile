...
deps:   rmdeps
	...
	rm -rf src/github.com/whosonfirst/go-whosonfirst-sqlite-features/vendor/github.com/mattn
	...
	rm -rf src/github.com/whosonfirst/go-whosonfirst-sqlite-features/vendor/github.com/whosonfirst/go-spatialite
